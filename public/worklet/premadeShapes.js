...
registerPaint("shapesBackground1", shapesWithBackgroundColor(colorGenerator1));
registerPaint("shapesBackground2", shapesWithBackgroundColor(colorGenerator2));
registerPaint("shapesBackground3", shapesWithBackgroundColor(colorGenerator3));
registerPaint("shapesBackground4", shapesWithBackgroundColor(colorGenerator4));
